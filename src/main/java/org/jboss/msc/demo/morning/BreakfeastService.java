 ...
 *
 */
public class BreakfeastService implements Service<Tooth> {

    private Tooth tooth;
    private InjectedValue<Bread> bread = new InjectedValue<Bread>();
    private InjectedValue<Coffee> coffee = new InjectedValue<Coffee>();
    /* 
     * 
    ...
    public Injector<Bread> getBreadInjector() {
        return bread;
    }
    
    public Injector<Coffee> getCoffeeInjector() {
        return coffee;
    }
